...
public class FirstActivity_old extends Activity {
    //-------------------attributes-------------------------//
    private int build=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ShowButton(true);
        build= PreferenceManager.getDefaultSharedPreferences(FirstActivity_old.this).getInt(BUILD,0);
      ...
      if(build!=178456239){
            ...
            buildButton.setOnClickListener(new View.OnClickListener(){
                 ...
                 *Building database
                */
                    mSQLite=new DataBaseManager(FirstActivity_old.this);
